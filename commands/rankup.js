...
module.exports.run = async (bot, message, args, cmd) => {
	let rankUpEmbed = new Discord.RichEmbed()
		...
		.setDescription("The H3X Staff team has created a system called the Tier Leader System. With this each tier has a leader or someone who is put in the position to get to know as many individuals as possible.")
		.addField("Here are the Tiers and Leaders (and those assisting each Tier)","Tier Elite-  iCharmanderZ3 \nTier 1-  BelnapZ3 \nTier 2-  BelnapZ3 \nTier 3-  BarouzH3X Tier 4-  captcrazybro_H3X \nTier 5- Be in the clan for 3 weeks to reach Tier 5 \nTier 6- Starters")
